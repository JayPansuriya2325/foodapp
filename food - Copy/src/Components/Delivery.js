  ...
  return (
    <div className='w-full bg-white py-16 px-4'>
      ...
      <div className='w-[1240px] mx-auto grid md:grid-cols-2'>
        <img className='w-[550px] mx-auto my-4' src={QuickDelivery}/>
        <div className='flex flex-col justify-center'>
            ...
            <button className='bg-black text-[#00df9a] w-[200px] rounded-md font-medium my-6 mx-auto md:mx-0 py-3 hover:scale-110 duration-300'>Get Started</button>
        </div>
'
      </div>
    </div>
